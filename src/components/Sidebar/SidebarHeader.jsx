...
export default function SidebarHeader({ setShowSidebar }) {
  return (
<div className="relative flex w-full h-[80px] p-4 items-center  xl:bg-brand-300 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)] z-50">
  ...
  <div className="flex items-end gap-2 mx-auto">
    <span className="text-2xl font-Aleo text-brand-800">AliSoliNejad</span>
